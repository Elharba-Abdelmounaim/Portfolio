...
document.addEventListener('DOMContentLoaded', function() {
    ...
    themeToggle.addEventListener('click', function() {
        ...
        // تغيير لون النافبار في الوضع الفاتح
        if (isDark) {
            navbar.style.setProperty('--navbar-bg', 'rgba(255, 255, 255, 0.9)');
            navbar.style.setProperty('--navbar-color', '#333');
        } else {
            navbar.style.setProperty('--navbar-bg', 'rgba(10, 10, 35, 0.9)');
            navbar.style.setProperty('--navbar-color', '#fff');
        }
    });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', function(e) {
            // Don't prevent default for actual download
